...
namespace WindowsFormsTrac
{
    public class BigTract
    {
       ...
       bool frontKovsh, bool backKovsh)
        ...
        public BigTract(int maxSpeed, float weight, Color mainColor, Color dopColor, bool frontKovsh, bool backKovsh, bool v) : this(maxSpeed, weight, mainColor, dopColor, frontKovsh, backKovsh)
        {
        }
